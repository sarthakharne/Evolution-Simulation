...
if __name__ == 'RLAgent':
    from ReplayBuffer import ReplayBuffer_GRU
elif __name__ == 'ActorCritic':
    from ReplayBuffer import ReplayBuffer_GRU
else:
    from Models.ReplayBuffer import ReplayBuffer_GRU
...
class RLAgent:
    ...
    def __init__(self, config):
        self.replay_buffer = ReplayBuffer_GRU.ReplayBuffer(config['capacity'])
